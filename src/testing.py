...
test1 = (duration_0, player1, overall_score_0, 
         round_score_0, streak_1, large_result)
test2 = (duration_small, player1, overall_score_0, 
         round_score_0, streak_1, large_result)
...
duration_hour = 60 * 60
small_result = 0
test3 = (duration_hour, player1, overall_score_0, 
         round_score_0, streak_1, small_result)
...
streak_5 = [5,0]
result_10 = 10
test4 = (duration_50, player1, overall_score_0, 
         round_score_0, streak_5, result_10)
...
streak_7 = [7,0]
result_140 = 140
test5 = (duration_5, player1, overall_score_0, 
         round_score_0, streak_7, result_140)

#/****************************************************************************/

#NOW RUN ALL TESTS TOGETHER
@pytest.mark.parametrize((
        'duration', 'player', 'score', 'round_score', 'streak', 'result'), 
        [test1, test2, test3, test4, test5])
def test_scorer(duration, player, score, round_score, streak, result):

    player_round_score = score_calc(duration, player, 
                                    score, round_score, streak)
    assert player_round_score[0] == result

#/****************************************************************************/
#/****************************************************************************/

#TESTING FOR CHECKING IF LETTER IN WORD 
# - TEST IF FUNCTION DETERMINES IF GUESSES LEFT REDUCES
...
#If 10 guesses left, and 'e' guessed, 'e' is in snake, so guesses stay 10
letter_e = 'e'
result_10 = 10
test6 = (letter_e, guess_word_snake, word_shown, 
         incorrect_guesses, guesses_left_10, result_10)

#If 10 guesses left, and 'f' guessed, 'f' isn't in snake, so guesses down to 9
letter_f = 'f'
result_9 = 9
test7 = (letter_f, guess_word_snake, word_shown, 
         incorrect_guesses, guesses_left_10, result_9)

#Test with double-letter words
#If 5 guesses left, and 'o' guessed, 'o' is in books, so guesses stay at 5
letter_o = 'o'
guesses_left_5 = 5
result_5 = 5
guess_word_books = ['b', 'o', 'o', 'k', 's']
test8 = (letter_o, guess_word_books, word_shown, 
         incorrect_guesses, guesses_left_5, result_5)

#If 7 guesses left, and 'z' guessed, 'z' isn't in snake, so guesses down to 6
letter_z = 'z'
guesses_left_7 = 7
result_6 = 6
test9 = (letter_z, guess_word_books, word_shown, 
         incorrect_guesses, guesses_left_7, result_6)

#If 1 guess left, and 's' guessed, 's' is in books, so guesses stay at 1
letter_s = 's'
guesses_left_1 = 1
result_1 = 1
test10 = (letter_s, guess_word_books, word_shown, 
          incorrect_guesses, guesses_left_1, result_1)
...
def test_guess_checker(letter, guess_word, word_shown, 
                       incorrect_guesses, guesses_left, result):

    guesses_left = guess_checker(letter, guess_word, word_shown, 
                                 incorrect_guesses, guesses_left)
